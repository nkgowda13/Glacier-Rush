...
void CCubeTree::Create(string directory, string filename)
{
    // Load the texture
...
std::vector<std::vector<int>> CCubeTree::GetIndices()
{
    std::vector<std::vector<int>> indices{
        std::vector<int>{0, 1, 2}, //base
            ...
            std::vector<int>{8, 12, 13},
            std::vector<int>{8, 13, 9},
            std::vector<int>{9, 13, 14},
            std::vector<int>{9, 14, 10},
            std::vector<int>{10, 14, 15},
            std::vector<int>{10, 15, 11},
            std::vector<int>{11, 15, 12},
            std::vector<int>{11, 12, 8},
            std::vector<int>{13, 12, 15},
            std::vector<int>{13, 15, 14}
    };
    return indices;
}

std::vector < glm::vec2 > CCubeTree::GetTexCoords()
{
...
std::vector<glm::vec3> CCubeTree::GetVertices()
{
    float barkSize = 0.5;
    int barkLength = 4;
    int treeSize = 4;
    ...
    std::vector<glm::vec3> vertices {
        ...
        glm::vec3(-barkSize, 0, barkSize),
            ...
            glm::vec3(-treeSize, treeHeight, treeSize),
            glm::vec3(-treeSize, treeHeight, -treeSize),
            glm::vec3(treeSize, treeHeight, -treeSize),
            glm::vec3(treeSize, treeHeight, treeSize)
...
std::vector<glm::vec3> CCubeTree::GetNormals(const std::vector<glm::vec3>& vertices, const std::vector<std::vector<int>>& indices) {
