...
glm::vec3 CFaceVertexMesh::ComputeTriangleNormal(unsigned int tId)
{
	CVertex v0, v1, v2;
	glm::vec3 normal, p, q;
...
void CFaceVertexMesh::ComputeTextureCoordsXZ(float xScale, float zScale)
{
